...
export function columns({ onEdit, onToggleActive, onDelete }: ColumnsProps): ColumnDef<User>[] {
  return [
    {
      ...
      cell: ({ row }) => {
        ...
        return avatarUrl ? (
          <Image src={avatarUrl} alt="Avatar utilisateur" width={40} height={40}
    ...
    },
    {
      ...
      header: "Vérifié",
      cell: ({ row }) => <div className="font-medium">{row.getValue("verified") ? "Oui" : "Non"}</div>,
    },
    {
