...
import { registerSchoolData as data } from "@/components/data/admin/register_school"

export function SchoolRegistrationDataTable () {
        ...
        <div className="w-full">
            <div className="md:flex items-center justify-between py-4">
                ...
                <Button className="flex gap-2 h-11 md:mt-0 mt-4">
                    <PlusCircleIcon />
                    <span> Enregistrer une école </span>
                </Button>
            </div>
